...
public class MessActivity extends AppCompatActivity {
    ...
    public void onClick(View view){
        ...
        if(userComplaint.getText().toString().equals("")||userRoom.getText().toString().equals("")||userName.getText().toString().equals("")) {
        ...
        else if(userComplaint.getText().toString().equals(prefs3.getString("MessComplaint",null))){
            ...
            prefs3.edit().putString("MessComplaint", enteredComplaint).apply();
            displayText.setText("Your Registered Complaint - " + enteredComplaint);
            mess.setValue(enteredComplaint);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displayText.setText("Your Registered Complaint - "+prefs3.getString("MessComplaint","No Complaints registered"));
    }
}
