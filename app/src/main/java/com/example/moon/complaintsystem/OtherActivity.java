...
import static com.example.moon.complaintsystem.MainActivity.others;
...
public class OtherActivity extends AppCompatActivity {
    ...
    public void onClick(View view){
        ...
        if(userComplaint.getText().toString().equals("")||userRoom.getText().toString().equals("")||userName.getText().toString().equals("")) {
        ...
        else if(userComplaint.getText().toString().equals(prefs6.getString("OtherComplaint",null))){
            ...
            prefs6.edit().putString("OtherComplaint", enteredComplaint).apply();
            displayText.setText("Your Registered Complaint - " + enteredComplaint);
            others.setValue(enteredComplaint);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displayText.setText("Your Registered Complaint - "+prefs6.getString("OtherComplaint","No Complaints registered"));
