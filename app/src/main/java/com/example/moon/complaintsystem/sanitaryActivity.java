...
public class sanitaryActivity extends AppCompatActivity {
    ...
    public void onClick(View view){
        ...
        if(userComplaint.getText().toString().equals("")||userRoom.getText().toString().equals("")||userName.getText().toString().equals("")) {
        ...
        else if(userComplaint.getText().toString().equals(prefs2.getString("SanitaryComplaint",null))){
            ...
            prefs2.edit().putString("SanitaryComplaint", enteredComplaint).apply();
            displayText.setText("Your Registered Complaint - " + enteredComplaint);
            sanitary.setValue(enteredComplaint);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displayText.setText("Your Registered Complaint - "+prefs2.getString("SanitaryComplaint","No Complaints registered"));
